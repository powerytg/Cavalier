package plugins.resources
{
	...
	import plugins.resources.actions.AddClipAction;
	import plugins.resources.actions.AssignTagAction;
	import plugins.resources.actions.ClipPropertyAction;
	import plugins.resources.actions.DeleteClipAction;
	import plugins.resources.actions.DeletePlaylistAction;
	import plugins.resources.actions.PlaylistPropertyAction;
	import plugins.resources.actions.PreviewAction;
	...
	import plugins.resources.parts.ActionBox;
	...
	public class ResourcesPlugin extends Plugin
	{
		...
		public function ResourcesPlugin(target:IEventDispatcher = null)
		{
			...
			_uiPartDescriptors.push(new UIPartDescriptor("Action Box", null, UIPartCatagory.EDITOR, ActionBox));
			...
			// Actions
			_actionDescriptors.push(new ActionDescriptor("clip", "ClipPropertyAction", ClipPropertyAction, "Properties", actionIcon));
			_actionDescriptors.push(new ActionDescriptor("clip", "AssignTagAction", AssignTagAction, "Assign Tags", actionIcon));
			_actionDescriptors.push(new ActionDescriptor("clip", "PreviewAction", PreviewAction, "Preview", actionIcon));
			_actionDescriptors.push(new ActionDescriptor("clip", "DeleteClipAction", DeleteClipAction, "Delete Selected", null, true));

			_actionDescriptors.push(new ActionDescriptor("playlist", "PlaylistPropertyAction",  PlaylistPropertyAction, "Properties", actionIcon));
			_actionDescriptors.push(new ActionDescriptor("playlist", "AddClipAction",  AddClipAction, "Add Clips", actionIcon));
			_actionDescriptors.push(new ActionDescriptor("playlist", "PreviewAction", PreviewAction, "Preview", actionIcon));
			_actionDescriptors.push(new ActionDescriptor("playlist", "DeletePlaylistAction", DeletePlaylistAction, "Delete Selected", null, true));
