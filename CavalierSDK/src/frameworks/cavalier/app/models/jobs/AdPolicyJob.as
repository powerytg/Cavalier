package frameworks.cavalier.app.models.jobs
{
	...
	public class AdPolicyJob extends Job
	{
		/**
		 * Constructor
		 */
		public function AdPolicyJob(target:IEventDispatcher=null)
		{
			super(target);
			modelType = "AdPolicy";
		}
		...
		override public function doUpdateAction():void{
			AdController.adController.changePolicy(policy, onSuccess, onFault);
		}
