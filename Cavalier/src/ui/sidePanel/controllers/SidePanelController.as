package ui.sidePanel.controllers
{
	...
	public class SidePanelController extends EventDispatcher
	{
		...
		protected function onSelectActivity(evt:ItemClickEvent):void{
			...
			// Unset the other entries
			for(var i:uint = 0; i < sidePanel.pluginAccordion.numElements; i++){
				var section:AccordionSection = sidePanel.pluginAccordion.getElementAt(i) as AccordionSection;
				var list:List = section.getElementAt(0) as List;
				if(list.dataProvider.getItemIndex(selectedActivityDescriptor) == -1)
